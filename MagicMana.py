...
#   MagicMana.py                                                       #
#                                                                      #
#       Monte Carlo simulation of the number of cards I can access     #
#       as a function of turns                                         #
#                                                                      #
########################################################################

import scipy, numpy, os, sys, pylab, copy
